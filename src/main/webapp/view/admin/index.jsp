...
<head>
<meta charset="UTF-8">
<title>Hashira | Admin Entertainment</title>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Welcome, ${sessionScope.currentUser.fullname}!</h3>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="<c:url value = '/view/assets/admin/images/dashboard/people.svg'/>" alt="people">
